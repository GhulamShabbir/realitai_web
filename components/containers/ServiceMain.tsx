                  ...
                  <div className="service-t-single-wrapper">
                    <div className="service-t__slider-single">
                      <div className="intro">
                        ...
                        <h4>
                          <Link href="service-single">Web3 Development</Link>
                        </h4>
                      </div>
                      <ul>
                        <li>Interactive web3 solutions</li>
                        <li>Blockchain </li>
                        <li>AI,IoT and cryptography</li>
                  ...
                  <div className="service-t-single-wrapper">
                    <div className="service-t__slider-single">
                      <div className="intro">
                        ...
                        <h4>
                          <Link href="service-single">Web App Development</Link>
                        </h4>
                      </div>
                      <ul>
